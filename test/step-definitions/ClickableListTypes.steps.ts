...
defineFeature(feature, (test) => {
  ...
  test('Customer selects a text option from the list', ({
    given,
    when,
    and,
    then,
  ...
  test('Customer selects an image option from the list', ({
    given,
    when,
    and,
    then,
    ...
    then(
      'the selected image should be displayed as an image in the chat',
      () => {},
    );
  ...
  test('Attempting to select multiple options after one selection', ({
    given,
    when,
    then,
    and,
    ...
    then(
      'the customer should not be able to select another option after the initial selection',
      () => {},
    );
